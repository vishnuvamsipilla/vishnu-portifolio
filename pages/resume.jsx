    ...
    <>
      ...
      <div className="max-w-[940px] mx-auto p-2 pt-[120px]">
        ...
        <div className="bg-[#d0d4d6] my-4 p-4 w-full flex justify-between items-center">
          <h2 className="text-center">Vishnu vamsi</h2>
          <div className="flex">
            <a
              href="https://www.linkedin.com/in/n-s-vishnu-vamsi-pilla-2a7347224/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://github.com/vishnuvamsipilla"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <div className="py-6">
          <p className="italic">
            <span className="font-bold italic">StackNexus</span>
            ,Inc
          </p>
          <p className="py-1 italic">
            Associate Software Developer (Apr 2022 - Current)
          </p>
